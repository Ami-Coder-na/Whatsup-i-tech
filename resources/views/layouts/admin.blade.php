...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="{{ route('admin.gallery') }}" class="{{ request()->routeIs('admin.gallery*') ? 'active' : '' }}"><i class="fa-solid fa-images"></i> গ্যালারি ম্যানেজমেন্ট</a></li>
            <li><a href="{{ route('admin.testimonials') }}" class="{{ request()->routeIs('admin.testimonials*') ? 'active' : '' }}"><i class="fa-solid fa-star"></i> ক্লায়েন্ট রিভিউ</a></li>
