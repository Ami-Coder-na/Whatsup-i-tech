    ...
    <div class="top-bar">
        <div class="container top-bar-content">
            ...
            <div class="top-bar-right">
                ...
                <a href="{{ route('faq') }}" style="color: var(--accent-orange); font-weight: 600;"><i class="fa-solid fa-circle-question"></i> FAQ</a>
...
<section style="background: radial-gradient(circle at top right, #111d42 0%, #050b1e 60%); color: white; padding: 60px 0 50px; text-align: center;">
    <div class="container">
        ...
        <h1 style="font-size: 38px; font-weight: 800; margin-top: 8px; margin-bottom: 12px;">FAQ (Frequently Asked Questions)</h1>
    </div>
</section>
