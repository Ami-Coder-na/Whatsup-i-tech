    ...
    <div class="top-bar">
        <div class="container top-bar-content">
            ...
            <div class="top-bar-right">
                ...
                <a href="{{ route('terms.conditions') }}" style="color: var(--accent-orange); font-weight: 600;"><i class="fa-solid fa-file-contract"></i> শর্তাবলী</a>
...
<section style="background: radial-gradient(circle at top right, #111d42 0%, #050b1e 60%); color: white; padding: 60px 0 50px; text-align: center;">
    <div class="container">
        <span style="color: var(--accent-orange); font-weight: 700; font-size: 14px; text-transform: uppercase;">সার্ভিস ব্যবহারের নিয়মাবলী</span>
        <h1 style="font-size: 38px; font-weight: 800; margin-top: 8px; margin-bottom: 12px;">নিয়ম ও শর্তাবলী (Terms & Conditions)</h1>
    </div>
</section>
